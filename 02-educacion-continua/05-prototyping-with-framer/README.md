...
Cada unidad tendrá:
* Tener su propio Readme
* Contar con ejercicios
* Haber pasado una revision en beta

# Indice

| # | Título | Duración | Tópico
| - | ---- | -------- | ------
| 01 | Introducción | ? min | []()
| 02 | Layers, Text Layers, Events | ? min | []()
| 03 | States | ? min | []()
| 04 | Animations | ? min | []()
| 05 | Scroll Component | ? min | []()
| 06 | Page Component | ? min | []()
| 07 | Slider & Range Slider Components | ? min | []()
| 08 | Usando Figma y el Flow Component | ? min | []()
| 09 | Loops y Arrays | ? min | []()
| 10 | Funciones Utils | ? min | []()
| 11 | Creando funciones | ? min | []()
| 12 | Creando classes | ? min | []()
| 13 | Usando funciones y classes juntos | ? min | []()
| 14 | Flexbox | ? min | []()
| 15 | Modules | ? min | []()
