...
- Profundizar en el tema de las entrevistas
- Entender cuál es el arco de una entrevista
...
![El arco de una entrevista](https://lh3.googleusercontent.com/zPu0LHwAeIjYPaYBZckRmsIvR9JxAOPJ1O40rIc5CDUNRjuJ61Gim5U9eFyEQncLIUCNCsx4YQgHhCd33lTQgARxGpgZ5rzewjvXgUTSwkncvdTkN-ca1aNIs4nt1VP33RLQjZc6dTU)
...
Una vez que has hecho algunas preguntas de fondo, puedes pasar al 'fondo' de la
entrevista. Si estás haciendo una investigación de observación o de usabilidad,
este es el momento en que todas tus preguntas de ese tipo irán. En este momento
en la entrevista generalmente será cuando más aprendes sobre el tema o producto
...
![easy password](https://lh4.googleusercontent.com/4j5qhjRslWE0XZdWdEzg3e-ptj8SDYnABBGB0v4Cff4uzsmJq8Cv7pgp5dZ9q6ROU3iYedf-1jcwr1___L1-hwrwITEcyJ9e0IXmqNj9INbcAbcUuf7cg7qNoIFRLy9v0QYWXHCJiA4)
...
lo hacen porque, para ellos, sí es seguro y conveniente.
...
hacen lo que dicen que harán, y viceversa.
...
Pégate al dicho `mostrar, no contar` (show, don't tell) siempre que puedas,
porque el feedback que recibas será mucho más rico y valioso.
...
esas preguntas con otra acerca de si leyeron los términos o no, y por qué no.
...
#### Los 5 pasos de una entrevista

Mira este video de GV:

[video GV](https://youtu.be/1jULaA68HS0)
